...
// meaning Manana (1) - Urgent (5). It's easy to add a new priority 
...
namespace ProgrammingToAnInterface
{
  class Program
  {
    ...
    static void Main(string[] args)
    {
      ...
      Console.WriteLine("\nShipping all packages (in priority order, of course):");
      ...
      Console.WriteLine("Shipped {0} packages", nTotalShipped);
      Trace.WriteLine(
...
// I do recommend a couple of books that will help you become a more
